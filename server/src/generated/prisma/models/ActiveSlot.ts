...
// @ts-nocheck 
/*
 * This file exports the `ActiveSlot` model and its related types.
 *
...
export type GetActiveSlotAggregateType<T extends ActiveSlotAggregateArgs> = {
      [P in keyof T & keyof AggregateActiveSlot]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateActiveSlot[P]>
    : Prisma.GetScalarType<T[P], AggregateActiveSlot[P]>
}
...
export type GetActiveSlotGroupByPayload<T extends ActiveSlotGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ActiveSlotGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ActiveSlotGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ActiveSlotGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ActiveSlotGroupByOutputType[P]>
      }
    >
  >
...
export type ActiveSlotCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ActiveSlotFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ActiveSlotDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ActiveSlot'], meta: { name: 'ActiveSlot' } }
  /**
   ...
   * })
  **/
  count<T extends ActiveSlotCountArgs>(
    args?: Prisma.Subset<T, ActiveSlotCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ActiveSlotCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ActiveSlotGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ActiveSlotGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetActiveSlotGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
